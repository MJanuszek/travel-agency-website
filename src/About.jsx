  ...
  return (
    <div id="about-section" className="about">
      ...
      <div className="info">
        ...
        <p>
          Na co dzień nauczycielem muzyki, weekenadmi przewodnikiem górkim.
          ...
          dźwięki i emocje. Jako przewodnik górski pokazuję piękno Sudetów i ich
          natury. Odkryj, jak można znaleźć harmonię pomiędzy tymi pasjami.
          <br />
        </p>
