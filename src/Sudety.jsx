  ...
  return (
    <div className="sudety wrapper" id="sudety">
      ...
      <p className="story">
        ...
        Polski, Czech i Niemiec. Choć nie są najwyższe, kryją w sobie niezwykłe
        bogactwo krajobrazów, tajemnic i historii. To tutaj znajdziemy zarówno
        łagodne wzniesienia, jak i strome urwiska, gęste lasy, wodospady oraz
        skalne labirynty, które inspirują wędrowców od wieków.
      </p>
      <p className="story">
